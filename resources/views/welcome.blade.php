            ...
            <div class="category-carousel swiper">
              <div class="swiper-wrapper">
                ...
                <a href="index.html" class="nav-link category-item swiper-slide">
                  <img src="{{asset('front/images/icon-vegetables-broccoli.png')}}" alt="Category Thumbnail">
              ...
              <div class="tabs-header d-flex justify-content-between border-bottom my-5">
                ...
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        ...
                        @foreach($kategori as $data)
                            <a href="#" class="nav-link text-uppercase fs-6" id="nav-{{ $data->id }}-tab" data-bs-toggle="tab" data-bs-target="#nav-{{ $data->id }}">{{ $data->nama }}</a>
                        @endforeach
                    </div>
                </nav>
                </div>
                            ...
                            @foreach ($produk as $data)
                                <div class="col">
                                    <div class="product-item">
                                        ...
                                        <h3>{{ $data->nama }}</h3>
                                        <span class="qty">stok : {{ $data->stok }}</span><span class="rating"> {{ $data->kategori->nama }}</span>
