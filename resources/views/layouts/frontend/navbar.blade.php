...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('filter/style.css') }}">
<style>
  body {
        ...
        <div class="row py-3 border-bottom">
          ...
          <div class="col-sm-4 col-lg-3 text-center text-sm-start">
            <div class="main-logo">
              <a href="{{ route('welcome') }}" class="text-decoration-none">
                <img src="{{asset('front/images/Xiaomi Logo.webp')}}" alt="logo" width="125" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-sm-6 offset-sm-2 offset-md-0 col-lg-5 d-none d-lg-block">
            <div class="search-bar row bg-light p-2 my-2 rounded-4">
              <div class="col-11 col-md-11">
                <form id="search-form" class="text-center" action="{{ route('welcome') }}" method="get">
                  @csrf
                  <input type="text" class="form-control border-0 bg-transparent" placeholder="Cari Beberapa Produk Dari Xiaomi" />
                </form>
              </div>
              <div class="col-1">
          ...
          <div class="col-sm-8 col-lg-4 d-flex justify-content-end gap-5 align-items-center mt-4 mt-sm-0 justify-content-center justify-content-sm-end">
            <div class="support-box text-end d-none d-xl-block">
              ...
              <h5 class="mb-0">+62895600076767</h5>
            </div>
            ...
            <ul class="d-flex justify-content-end list-unstyled m-0">
                @guest
                    <div class="dropdown">
                        <a href="#" class="rounded-circle bg-light p-2 mx-1" id="userDropdown" data-bs-toggle="dropdown" aria-expanded="false">
